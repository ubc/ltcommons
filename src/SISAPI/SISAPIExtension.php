...
/**
 * Class SISAPIExtension Dependency inject extension for SIS API. This extension helps to
 ...
 * @package UBC\SISAPI
 */
class SISAPIExtension implements ExtensionInterface
{
    /**
